...
class App {
  ...
  // Middleware and controllers instances
  ...
  constructor(port: number) {
    ...
    this.appController = new AppController(this.staffuserService, this.patientService);
    ...
    // Add routes: Tell express what to do when our routes are visited
